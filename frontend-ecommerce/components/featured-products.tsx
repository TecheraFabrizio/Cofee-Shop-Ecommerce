									...
									<div className="p-1">
										<Card className="py-4 border border-gray-200 shadow-none">
											<CardContent className="relative flex items-center justify-center px-6 py-2">
												...
												<div className="absolute w-ful px-6 transition duration-200 opacity-0 group-hover:opacity-100 bottom-5">
											...
											<div className="flex justify-between gap-4 px-8">
												...
												<div className="flex items-center justify-between gap-3">
													<p className="px-2 py-1 rounded-full w-fit bg-[var(--color-primary)] text-[var(--color-primary-foreground)]">{taste}</p>
													<p className="px-2 py-1 rounded-full w-fit bg-[var(--color-chart-4)] text-[var(--color-foreground)]">{origin}</p>
												</div>
											</div>
										</Card>
									</div>
